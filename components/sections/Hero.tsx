    ...
    >
      ...
      <ContentContainer className="relative z-10 flex flex-col gap-stack-lg max-md:min-h-0 max-md:flex-1 max-md:gap-6">
        <div className="max-md:mx-auto max-md:flex max-md:w-full max-md:max-w-[85vw] max-md:flex-1 max-md:flex-col md:contents">
          ...
          <div
            aria-hidden
            className="hero-mobile-mockup-slot max-md:relative max-md:mt-9 max-md:min-h-0 max-md:flex-1 md:hidden"
          >
            <Image
              alt=""
              className="hero-mobile-mockup-image max-md:pointer-events-none max-md:absolute max-md:top-0 max-md:max-w-none"
              height={1512}
              priority
              sizes="100vw"
